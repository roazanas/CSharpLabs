...
namespace Lab13.ClassLibrary
{
    public class Receipt : Document
    {
        ...
        {
            return $"Чек: Сумма: {Amount} руб., способ оплаты: \"{PaymentMethod}\" | {base.ToString()}";
        }
        ...
        {
            return $"Информация о чеке: №{Number}, сумма: {Amount} руб., способ оплаты: \"{PaymentMethod}\", "
                 + $"дата: {Date:dd.MM.yyyy}, кассир: {Author}";
        }
