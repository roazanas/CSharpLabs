...
namespace Lab10.ClassLibrary
{
    public class Invoice : Document
    {
        ...
        {
            return $"<DRED>Накладная<WHITE>: {Quantity} единиц товара \"<YELLOW>{ProductType}<WHITE>\" на сумму {Amount} руб. | {base.ToString()}";
        }
        ...
        {
            return $"Информация о накладной: №{Number}, {Quantity} единиц товара \"<YELLOW>{ProductType}<WHITE>\" "
                 + $"на сумму {Amount} руб., дата: {Date:dd.MM.yyyy}, поставщик: <YELLOW>{Author}";
        }
